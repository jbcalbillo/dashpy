...
if uploaded_file is not None:
    ...
    if isinstance(data, list):
        for candidate in data:
            ...
            st.write(f"Fecha de Postulación: {candidate.get('fechaPostulacion', 'N/A')}")
            ...
            st.write(f"Género: {candidate.get('genero', 'N/A')}")
            ...
            st.write(f"Teléfono: {candidate.get('telefono', 'N/A')}")
